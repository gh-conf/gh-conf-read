...
- Go to [Repository](https://github.com/arshadkazmi42/gh-read-conf/)
- Create Pull Request against `master` branch
- Add a suitable title and description to the pull request and tag the issue number in Pull Request description, if the pull request is related to some issue logged here: [Issues](https://github.com/arshadkazmi42/gh-read-conf/issues)
